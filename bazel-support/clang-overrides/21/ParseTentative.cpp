...
//===----------------------------------------------------------------------===//
//
// CTC override of the LLVM 21.1.x archive member (see BUILD.bazel): fixes the
// spurious access errors that isCXXDeclarationStatement emits for out-of-line
// members of private nested types under -fincremental-extensions. Carries the
// upstream fix f6f0503673b7 plus the CTC nested-name-specifier fix. Remove
// this file when @llvm moves to a tree that contains both fixes.
//===----------------------------------------------------------------------===//
